...
const CellBoard = () => {
  ...
  const { data, isError, isLoading } = useContractRead({
    address: "0x37f71e3E5244DD909658CeE5E3AA0516A66EC584",
    abi: cellAbi.abi,
      ...
      <div className="bg-slate-900 pb-8">
        <div className="min-h-screen flex items-center justify-center">
          <div className="max-w-3xl mx-auto relative">
            <div className="flex flex-col gap-y-5 justify-center mb-10">
              <h1 className="text-[#6A43ED] font-extrabold text-5xl">
              ChromaCraft
              </h1>
              <p className="text-white">
                <span className="font-bold text-[#6A43ED]">Guidelines</span>:
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-between mt-10 mb-4">
                  <div className="flex rounded-md shadow-sm">
                    <span className="px-4 inline-flex items-center min-w-fit rounded-l-md bg-gray-500 text-sm text-white font-bold">
                      X
                    </span>
                    <input
                      type="text"
                      ref={xCoordinate}
                      name="x"
                      className="py-2 px-3 pr-11 block w-full shadow-sm rounded-r-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 "
                    />
                  </div>
                  <div className="flex rounded-md shadow-sm">
                    <span className="px-4 inline-flex items-center min-w-fit rounded-l-md bg-gray-500 text-sm text-white font-bold">
